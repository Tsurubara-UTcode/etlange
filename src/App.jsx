...
export default function QuizGame() {
  ...
  return (
    <div className="bg-cover" style={{ backgroundImage: "url('/materials/background.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat",
      ...
      <p className="custom-font dashed" style={{ position: "absolute", top: "0px", right: "40px", textAlign: "right", color: "white", fontSize: "7rem", paddingTop: "0pt", paddingBottom: "0pt", width: "auto" }}>
        {formatTime(timer)}
      </p>
